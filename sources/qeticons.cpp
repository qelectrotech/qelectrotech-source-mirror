...
void QET::Icons::initIcons()
{
	...
	AddFolio            .addFile(":/ico/scalable/folio-new.svg");
	...
	Autoconnect         .addFile(":/ico/scalable/autoconnect.svg");
	BringForward        .addFile(":/ico/scalable/bring_forward.svg");
	Cancel              .addFile(":/ico/scalable/item-cancel.svg");
	Company             .addFile(":/ico/scalable/go-company.svg");
	Conductor           .addFile(":/ico/scalable/conductor.svg");
	ConductorEdit       .addFile(":/ico/scalable/conductor-edit.svg");
	ConductorSettings   .addFile(":/ico/scalable/conductor-reset.svg");
	Configure           .addFile(":/ico/16x16/configure.png");
	Configure           .addFile(":/ico/22x22/configure.png");
	ConfigureToolbars   .addFile(":/ico/scalable/panel-projects.svg");
	IC_CopyFile         .addFile(":/ico/scalable/item-copy.svg");
	DiagramAdd          .addFile(":/ico/scalable/folio-new.svg");
	Diagram             .addFile(":/ico/scalable/diagram.svg");
	DiagramBg           .addFile(":/ico/scalable/diagram_bg.svg");
	DiagramDelete       .addFile(":/ico/scalable/folio-delete.svg");
	DialogCancel        .addFile(":/ico/16x16/dialog-cancel.png");
	DialogCancel        .addFile(":/ico/22x22/dialog-cancel.png");
	DialogInformation   .addFile(":/ico/scalable/folio-properties.svg");
	...
	DocumentSpreadsheet .addFile(":/ico/scalable/export-csv.svg");
	...
	East                .addFile(":/ico/scalable/east.svg");
	EditClear           .addFile(":/ico/scalable/project-clean.svg");
	EditText            .addFile(":/ico/scalable/names.svg");
	...
	ElementDelete       .addFile(":/ico/scalable/element-delete.svg");
	ElementEdit         .addFile(":/ico/scalable/element-edit.svg");
	ElementNew          .addFile(":/ico/scalable/element-new.svg");
	ElementSmall        .addFile(":/ico/scalable/element.svg");
	EndLineCircle       .addFile(":/ico/scalable/endline-circle.svg");
	EndLineDiamond      .addFile(":/ico/scalable/endline-diamond.svg");
	EndLineNone         .addFile(":/ico/scalable/endline-none.svg");
	EndLineSimple       .addFile(":/ico/scalable/endline-simple.svg");
	EndLineTriangle     .addFile(":/ico/scalable/endline-triangle.svg");
	EPS                 .addFile(":/ico/32x32/image-x-eps.png");
	Flip                .addFile(":/ico/scalable/flip.svg");
	Folder              .addFile(":/ico/16x16/folder.png");
	FolderDelete        .addFile(":/ico/scalable/folder-delete.svg");
	FolderEdit          .addFile(":/ico/scalable/folder-edit.svg");
	FolderNew           .addFile(":/ico/16x16/folder-new.png");
	FolderNew           .addFile(":/ico/22x22/folder-new.png");
	FolderOnlyThis      .addFile(":/ico/scalable/folder-only-this.svg");
	FolderOpen          .addFile(":/ico/16x16/folder-open.png");
	FolderOpen          .addFile(":/ico/22x22/folder-open.png");
	FolderProperties    .addFile(":/ico/scalable/folder-properties.svg");
	FolderShowAll       .addFile(":/ico/scalable/folder-show-all.svg");
	...
	GoDownDouble        .addFile(":/ico/scalable/go-down-double.svg");
	GoTop               .addFile(":/ico/16x16/go-top.png");
	GoUp                .addFile(":/ico/16x16/go-up.png");
	GoUp                .addFile(":/ico/22x22/go-up.png");
	GoUpDouble          .addFile(":/ico/scalable/go-up-double.svg");
	Ground              .addFile(":/ico/scalable/ground.svg");
	Grid                .addFile(":/ico/scalable/grid.svg");
	Hide                .addFile(":/ico/scalable/masquer.svg");
	Home                .addFile(":/ico/16x16/go-home.png");
	Home                .addFile(":/ico/22x22/go-home.png");
	HotSpot             .addFile(":/ico/scalable/hotspot.svg");
	InsertImage         .addFile(":/ico/22x22/insert-image.png");
	Lower               .addFile(":/ico/scalable/lower.svg");
	IC_MoveFile         .addFile(":/ico/scalable/item-move.svg");
	Mirror              .addFile(":/ico/scalable/mirror.svg");
	Names               .addFile(":/ico/scalable/names.svg");
	Neutral             .addFile(":/ico/scalable/neutral.svg");
	NewDiagram          .addFile(":/ico/scalable/diagram.svg");
	North               .addFile(":/ico/scalable/north.svg");
	...
	Orientations        .addFile(":/ico/scalable/orientations.svg");
	PartArc             .addFile(":/ico/scalable/arc.svg");
	PartCircle          .addFile(":/ico/scalable/circle.svg");
	PartEllipse         .addFile(":/ico/scalable/ellipse.svg");
	PartLine            .addFile(":/ico/scalable/line.svg");
	PartPolygon         .addFile(":/ico/scalable/polygon.svg");
	PartRectangle       .addFile(":/ico/scalable/rectangle.svg");
	PartSelect          .addFile(":/ico/16x16/select.png");
	PartSelect          .addFile(":/ico/22x22/select.png");
	PartText            .addFile(":/ico/scalable/text.svg");
	PartTextField       .addFile(":/ico/scalable/textfield.svg");
	PDF                 .addFile(":/ico/scalable/export-pdf.svg");
	Phase               .addFile(":/ico/scalable/phase.svg");
	PrintAllPages       .addFile(":/ico/scalable/all_pages.svg");
	Printer             .addFile(":/ico/32x32/printer.png");
	Printer             .addFile(":/ico/128x128/printer.png");
	PrintLandscape      .addFile(":/ico/scalable/landscape.svg");
	PrintPortrait       .addFile(":/ico/scalable/portrait.svg");
	PrintTwoPages       .addFile(":/ico/scalable/two_pages.svg");
	Projects            .addFile(":/ico/scalable/project.svg");
	ProjectClose        .addFile(":/ico/scalable/project-close.svg");
	ProjectNew          .addFile(":/ico/scalable/project-new.svg");
	...
	ProjectProperties   .addFile(":/ico/scalable/project-properties.svg");
	...
	ProjectFileGP       .addFile(":/ico/scalable/project.svg");
	...
	Raise               .addFile(":/ico/scalable/raise.svg");
	...
	Restore             .addFile(":/ico/scalable/restaurer.svg");
	RunDxf              .addFile(":/ico/scalable/run-dxf.svg");
	SendBackward        .addFile(":/ico/scalable/send_backward.svg");
	Settings            .addFile(":/ico/scalable/settings.svg");
	SinglePage          .addFile(":/ico/scalable/single_page.svg");
	South               .addFile(":/ico/scalable/south.svg");
	Start               .addFile(":/ico/scalable/start.svg");
	TableOfContent      .addFile(":/ico/scalable/table-of-content.svg");
	Terminal            .addFile(":/ico/scalable/terminal.svg");
	TerminalStrip       .addFile(":/ico/scalable/terminalstrip.svg");
	TitleBlock          .addFile(":/ico/16x16/label.png");
	TitleBlock          .addFile(":/ico/22x22/label.png");
	TitleBlockBottom    .addFile(":/ico/scalable/titleblock-bottom.svg");
	TitleBlockRight     .addFile(":/ico/scalable/titleblock-right.svg");
	...
	ViewFitWidth        .addFile(":/ico/scalable/view_fit_width.svg");
	ViewFitWindow       .addFile(":/ico/scalable/view-fit-window.svg");
	ViewMove            .addFile(":/ico/scalable/move.svg");
	if (rtl) {
	...
	West                .addFile(":/ico/scalable/west.svg");
	...
	listDrawings        .addFile(":/ico/scalable/folio-list.svg");
	...
	ElementMaster       .addFile(":/ico/scalable/element-master.svg");
	ElementSlave        .addFile(":/ico/scalable/element-slave.svg");
	FolioXrefComing     .addFile(":/ico/scalable/folio-ref-coming.svg");
	ElementTerminal     .addFile(":/ico/scalable/terminal.svg");
