...
cmake -S "$SOURCE_DIR" -B "$BUILD_DIR" -G Ninja \
  ...
  -DQET_COMMON_COLLECTION_PATH_RELATIVE_TO_BINARY_PATH=TRUE \
  -DQET_COMMON_COLLECTION_PATH="../share/elements/" \
  -DQET_COMMON_TBT_PATH="../share/titleblocks/" \
  -DQET_LANG_PATH_RELATIVE_TO_BINARY_PATH=TRUE \
  -DQET_LANG_PATH="../share/lang/" 
